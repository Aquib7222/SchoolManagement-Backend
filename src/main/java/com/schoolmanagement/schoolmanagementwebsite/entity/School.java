...
public class School {
    ...
    private String academicSessionStartMonth;

    private String academicSessionFormat;
    ...
    @Builder.Default
    private Boolean allowParentLogin = true;

    @Builder.Default
    private Boolean allowStudentLogin = true;
    ...
    protected void onCreate() {
        ...
        if (allowParentLogin == null) {
            allowParentLogin = true;
        }

        if (allowStudentLogin == null) {
